...
//for(const[i,element] of types.entries()){
  //  index_of[element]=i
//}


//initialdate="2022-03-01 02:00:00"

//newdate="2022-03-05 01:30:00"

//var totalindex=calindex(initialdate,newdate)

//console.log("totalindex is ", totalindex)

//var total=calindex(initialdate,newdate)
...
//console.log(Math.abs(newdate-initialdate)/(1000 * 3600 * 24))
