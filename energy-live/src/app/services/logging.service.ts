...
export class LoggingService{
    ...
    getUserData() {
        ...
        this.httpClient.get('https://paparrigopoulos.com/api/users/login', {params: params}).pipe(take(1)).subscribe((data: any) => {
    ...
    extendUserPlan(extend: number) {
        ...
        return this.httpClient.get('https://paparrigopoulos.com/api/users/extend', {params: params});
    }
}